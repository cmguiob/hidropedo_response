...
A continuación se definien y envían parámetros de procesamiento generales para todos los productos satelitales, para ejecutar en GEE. Los datos ya procesados se envian a Google Drive a la carpeta GEE_exports, desde donde deben reubicarse. Las tareas se puede monitorear en [Earth Engine Task Manager](https://code.earthengine.google.com/tasks)
